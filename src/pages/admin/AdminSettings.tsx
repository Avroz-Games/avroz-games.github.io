...
export default function AdminSettings() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    await updateSettings({
      platformName: form.storeName,
      platformDescription: form.storeDescription,
      platformFeePercent: form.marginPercent,
      pixDiscountPercent: form.pixDiscountPercent,
      originCep: form.originCep.replace(/\D/g, ''),
      platformPixKey: form.pixKey,
      platformPixKeyType: form.pixKeyType,
      supportEmail: form.email,
      supportWhatsapp: form.whatsapp,
    })
